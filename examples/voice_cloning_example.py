...
from llamasesame import calculate_voice_metrics, clone_voice, init_models
...
def main():
    ...
    if not os.path.exists(audio_file):
        ...
        print(
            "Please add a WAV file at this location or update the path in this script."
        )
        return
    ...
    synthesis_text = (
        "Hello, I'm speaking with a cloned voice. This technology is amazing!"
    )
