# Contributing to LlamaSesame

Thank you for your interest in contributing to LlamaSesame! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaSesame:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamasesame.git
   cd llamasesame
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamasesame.git
   ```
...
By contributing to LlamaSesame, you agree that your contributions will be licensed under the project's MIT License.
