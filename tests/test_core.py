...
def test_batch_process(mock_init_models):
    ...
    # Create temp files for testing
    with tempfile.NamedTemporaryFile(suffix=".wav") as temp_audio1, \
         tempfile.NamedTemporaryFile(suffix=".wav") as temp_audio2:
        ...
        with mock.patch("llamasesame.app.core.clone_voice") as mock_clone_voice:
            mock_clone_voice.side_effect = lambda **kwargs: f"/tmp/output_{kwargs['text']}.wav"
